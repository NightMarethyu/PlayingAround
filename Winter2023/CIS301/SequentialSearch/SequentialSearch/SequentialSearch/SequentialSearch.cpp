...
int main(int argc, char** argv)
{
    ...
    // This will get the count for the number of searches to do
    getline(ifs, gl);
    count = stoi(gl);
    double totalSearch = 0;

    // Here I will loop over the searches in the file and send them to the sequential search function
    for (int i = 0; i < count; i++) {
        string idStr;
        getline(ifs, idStr);
    ...
    // This will print out the average number of searches the program does
...
// This will loop through the people vector and search for a matching ID number, it will return the number of searches peformed
